...
# 定义表头
headers = [
    '食物ID', '/', '别名或俗名', '英文名称', '食部 Edible', '水分 Water', '能量 Energy',
    '蛋白质 Protein', '脂肪 Fat', '胆固醇 Cholesterol', '灰分 Ash',
    '碳水化合物 CHO', '总膳食纤维 Dietary fiber', '胡萝卜素 Carotene',
    '维生素 AVitamin', 'α - TE', '硫胺素 Thiamin', '核黄素 Riboflavin',
    '烟酸 Niacin', '维生素 CVitamin C', '钙 Ca', '磷 P', '钾 K', '钠 Na',
    '镁 Mg', '铁 Fe', '锌 Zn', '硒 Se', '铜 Cu', '锰 Mn', '碘 I', '/',
    '饱和脂肪酸 SFA', '单不饱和脂肪酸 MUFA', '多不饱和脂肪酸 PUFA',
    '合计 Total', '一级分类ID', '二级分类ID', '二级分类名称', '一级分类名称'
]
